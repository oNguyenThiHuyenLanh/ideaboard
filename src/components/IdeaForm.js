    ...
    return (
      <div className="title">
        <form onBlur={this.handleBlur} >
          <input className="input" type="text" name="title" placeholder="Enter a title pleaseeee" value={this.state.title} onChange={this.handleInput} ref={this.props.titleRef}/>
